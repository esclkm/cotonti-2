...
$xx = 0;
/* === Hook - Part1 : Set === */
$extp = cot_getextensions('forums.sections.loop');
/* ===== */
/* === Hook - Part1 : Set === */
$extps = cot_getextensions('forums.sections.loop.sections');
/* ===== */
/* === Hook - Part1 : Set === */
$extpss = cot_getextensions('forums.sections.loop.subsections');
/* ===== */
foreach ($fstlvl as $x)
{
