...
$t = new XTemplate(cot_tplfile('admin.rightsbyitem', 'system'));
...
/* === Hook === */
foreach (cot_getextensions('admin.rightsbyitem.first') as $ext)
{
	include $ext;
}
/* ===== */
...
if ($a == 'update')
{
	...
	/* === Hook === */
	foreach (cot_getextensions('admin.rightsbyitem.update') as $ext)
	{
		include $ext;
	}
	/* ===== */
...
foreach (cot_getextensions('admin.rightsbyitem.case') as $ext)
{
	include $ext;
}
/* ===== */
...
/* === Hook === */
foreach (cot_getextensions('admin.rightsbyitem.tags') as $ext)
{
	include $ext;
}
/* ===== */
